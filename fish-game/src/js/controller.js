...
var global = require('./global'); //全局类
var util = require('./util');//工具类
var Ane = require('./ane');//海葵类
var Baby = require('./baby');//小鱼
var Dust = require('./dust');//灰尘类
var Fruit = require('./fruit');//水果类
var Halo = require('./halo');//大鱼喂小鱼的光环类
var Mom = require('./mom');//鱼妈妈类
var Score = require('./score');//数据类
var Wave = require('./wave');//大鱼吃果实波浪类
/***********************以上为模块注入***************************/
